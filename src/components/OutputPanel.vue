...
<template>
  <div style="display: inline-flex; flex-direction: column; align-items: flex-start; margin: 0 auto">
    ...
    <div style="display: flex; align-items: baseline; gap: 8px">
      <span class="label" style="font-size: 12pt; width: 70px; text-align: right">BOCF</span>
      <span style="font-size: 16pt" v-html="props.ordinalHtml"></span>
    </div>

    <!-- Veblen output -->
    <div style="display: flex; align-items: baseline; gap: 8px; margin-top: 8px">
      <span class="label" style="font-size: 12pt; width: 70px; text-align: right">Veblen</span>
      <span style="font-size: 14pt" v-html="props.veblenHtml"></span>
    </div>

    <!-- 0-Y output -->
    <div style="display: flex; align-items: baseline; gap: 8px; margin-top: 8px">
      <span class="label" style="font-size: 12pt; width: 70px; text-align: right">0-Y</span>
    ...
    <div v-if="props.showUpmsRow" style="display: flex; align-items: baseline; gap: 8px; margin-top: 6px">
      <span class="label" style="font-size: 12pt; width: 70px; text-align: right">UPMS</span>
    ...
    <div v-if="props.showDbmsRow" style="display: flex; align-items: baseline; gap: 8px; margin-top: 6px">
      <span class="label" style="font-size: 12pt; width: 70px; text-align: right">DBMS</span>
    ...
    <div v-if="props.showTriangularRow" style="display: flex; align-items: baseline; gap: 8px; margin-top: 6px">
      <span class="label" style="font-size: 12pt; width: 70px; text-align: right">Tri BMS</span>
      <span class="mono" style="font-size: 11pt; font-family: monospace; word-break: break-all" v-html="props.triangularHtml"></span>
    </div>

    <!-- PSS Hydra output -->
    <div v-if="props.showHydraRow" style="display: flex; align-items: baseline; gap: 8px; margin-top: 6px">
      <span class="label" style="font-size: 9pt; width: 70px; text-align: right">PSS Hydra</span>
      <span class="mono" style="font-size: 11pt; font-family: monospace; word-break: break-all" v-html="props.hydraHtml"></span>
    </div>

    <!-- HPrSS output -->
    <div v-if="props.showHprssRow" style="display: flex; align-items: baseline; gap: 8px; margin-top: 6px">
      <span class="label" style="font-size: 12pt; width: 70px; text-align: right">HPrSS</span>
      <span class="mono" style="font-size: 11pt; font-family: monospace; word-break: break-all" v-html="props.hprssHtml"></span>
    </div>

    <!-- LPrSS output -->
    <div v-if="props.showLprssRow" style="display: flex; align-items: baseline; gap: 8px; margin-top: 6px">
      <span class="label" style="font-size: 12pt; width: 70px; text-align: right">LPrSS</span>
      <span class="mono" style="font-size: 11pt; font-family: monospace; word-break: break-all" v-html="props.lprssHtml"></span>
    </div>

    <!-- BMS output row -->
    <div v-if="props.showBmsRow" style="display: flex; align-items: center; gap: 8px; margin-top: 6px; flex-wrap: wrap">
      <span class="label" style="font-size: 12pt; width: 70px; text-align: right">BMS</span>
